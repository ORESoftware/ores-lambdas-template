...
# flags-2-env audits this runtime contract before the listener starts. Keep it in the image at a
# stable working directory; omitting it creates an image that builds successfully but cannot boot.
WORKDIR /app
